...
// add animation by using framer motion
                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1
                            ...
                            initial="hidden"
                            animate="visible"
                            className="pb-16 text-5xl font-thin tracking-tight lg:mt-16 lg:text-7xl">Pranjal Mittal</motion.h1>
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <motion.img
                            ...
                            className="rounded-2xl" src={profilePic} alt="Pranjal Mittal" />
                    </div>
                </div>
            </div>
